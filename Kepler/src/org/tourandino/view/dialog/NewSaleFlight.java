...
public class NewSaleFlight extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public NewSaleFlight(JFrame parent, boolean modal, LoginController loginController, DailyCashRecordController dailyCashRecordController) {
		super(parent, modal);
		...
		orderController.initializeFlightOrder(loginController.getUser(), getTitle());
	...
	private void initializeComponents(){
		...
		btnDate.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		...
		btnSearch1.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnCustAdd.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		tabbedPane.addTab("Pasajeros/Tramos", null, panelDestiny, null);
		panelDestiny.setLayout(null);
		
		JScrollPane scrollPane = new JScrollPane();
		scrollPane.setBounds(12, 145, 759, 320);
		...
		JLabel lblItinerary = new JLabel("Tramo", SwingConstants.RIGHT);
		...
		txtItinerary.setBounds(100, 77, 200, 19);
		...
		btnSearch.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnDelItinerary.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/delete.png")));
		btnDelItinerary.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		btnDelItinerary.setBounds(654, 108, 117, 25);
		...
		btnAddItinerary.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/add.png")));
		btnAddItinerary.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		btnAddItinerary.setBounds(525, 108, 117, 25);
		...
		btnPassAdd.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		lblEfectivo.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/money.png")));
		...
		lblCuenta.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/account_balances.png")));
		...
		lblCheque2.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/cheque.png")));
		...
		lblCredito.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/visa.png")));
		...
		lblDebito.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/visa_electron.png")));
		...
		btnIssuerAdd.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPayment.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnConfirm.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/accept.png")));
		...
		btnCancel.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/cancel.png")));
		...
		btnDelPayment.setIcon(new ImageIcon(NewSaleFlight.class.getResource("/ar/com/tourandino/resources/delete.png")));
					...
					if(orderController.getTotalCash() > 0){
						if(dailyCashRecordController.dailyRecordExist()){
							if(!dailyCashRecordController.DailyRecordIsClosed()){
								if(orderController.createFlight(cmbIssuers.getSelectedItem()) > 0){
									JOptionPane.showMessageDialog(this, "La operac\u00f3on se complet\u00f3 exitosamente.", this.getTitle(), JOptionPane.WARNING_MESSAGE, new ImageIcon(Main.class.getResource("/ar/com/tourandino/resources/information.png")));
									dispose();
								}
								else
	...
	private void btnAddItineraryActionPerformed(ActionEvent evt){
		if(passengerController.getPassenger() != null){
			if(!txtItinerary.getText().isEmpty()){
				if(!txtPrice.getText().isEmpty()){
					if(!txtCost.getText().isEmpty()){
						try{
							orderController.addFlightItinerary(Float.parseFloat(txtPrice.getText()), Float.parseFloat(txtCost.getText()), txtItinerary.getText());
				...
				JOptionPane.showMessageDialog(this, "Ingrese el tramo", this.getTitle(), JOptionPane.WARNING_MESSAGE, new ImageIcon(Main.class.getResource("/ar/com/tourandino/resources/warning.png")));
		}
		else
	...
	private void btnDelItineraryActionPerformed(ActionEvent evt){
		try{
			...
			int columnIndex = 0;
			orderController.removeFlightItinerary(Integer.parseInt(tablePassengers.getModel().getValueAt(rowIndex, columnIndex).toString()));
			loadTable(tablePassengers);
		}
	...
	private void loadTable(JTable table){
		table.setModel(orderController.readFlightPassengers());
