...
public class NewSaleHotel extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public NewSaleHotel(JFrame parent, boolean modal, LoginController loginController, DailyCashRecordController dailyCashRecordController) {
		super(parent, modal);
		...
		orderController.initializeHotelOrder(loginController.getUser(), getTitle());
	...
	private void initializeComponents(){
		setResizable(false);
		setTitle("VENTA DE RESERVAS(HOTEL)");
		...
		btnDate.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		...
		btnSearch1.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnCustAdd.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		tabbedPane.addTab("Pasajeros/Hotel", null, panelDestiny, null);
		...
		JLabel lblItinerary = new JLabel("Hotel", SwingConstants.RIGHT);
		lblItinerary.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblItinerary.setBounds(12, 79, 70, 15);
		...
		txtHotel.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtHotel.setBounds(100, 77, 200, 19);
		panelDestiny.add(txtHotel);
		...
		btnSearch.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnDelItinerary.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/delete.png")));
		...
		btnAddItinerary.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPassAdd.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		JLabel lblAddressCity = new JLabel("Dirección", SwingConstants.RIGHT);
		lblAddressCity.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblAddressCity.setBounds(12, 108, 70, 15);
		panelDestiny.add(lblAddressCity);
		
		txtAddressCity = new JTextField();
		txtAddressCity.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtAddressCity.setColumns(10);
		txtAddressCity.setBounds(100, 106, 200, 19);
		panelDestiny.add(txtAddressCity);
		
		JLabel lblRoom = new JLabel("Habitación", SwingConstants.RIGHT);
		lblRoom.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblRoom.setBounds(12, 137, 70, 15);
		panelDestiny.add(lblRoom);
		
		txtRooms = new JTextField();
		txtRooms.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtRooms.setColumns(10);
		txtRooms.setBounds(100, 135, 200, 19);
		panelDestiny.add(txtRooms);
		...
		btnCheckIn.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		btnCheckIn.setToolTipText("Buscar");
		btnCheckIn.setBounds(275, 166, 25, 25);
		panelDestiny.add(btnCheckIn);
		...
		btnCheckOut.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		btnCheckOut.setToolTipText("Buscar");
		btnCheckOut.setBounds(275, 203, 25, 25);
		panelDestiny.add(btnCheckOut);
		
		JLabel lblCheckIn = new JLabel("CheckIn", SwingConstants.RIGHT);
		lblCheckIn.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblCheckIn.setBounds(12, 171, 70, 15);
		panelDestiny.add(lblCheckIn);
		
		JLabel lblCheckOut = new JLabel("CheckOut", SwingConstants.RIGHT);
		lblCheckOut.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblCheckOut.setBounds(12, 208, 70, 15);
		panelDestiny.add(lblCheckOut);
		
		txtCheckIn = new JTextField();
		txtCheckIn.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtCheckIn.setColumns(10);
		txtCheckIn.setBounds(100, 169, 163, 19);
		panelDestiny.add(txtCheckIn);
		
		txtCheckOut = new JTextField();
		txtCheckOut.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtCheckOut.setColumns(10);
		txtCheckOut.setBounds(100, 206, 163, 19);
		panelDestiny.add(txtCheckOut);
		...
		lblEfectivo.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/money.png")));
		...
		lblCuenta.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/account_balances.png")));
		...
		lblCheque2.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/cheque.png")));
		...
		lblCredito.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/visa.png")));
		...
		lblDebito.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/visa_electron.png")));
		...
		btnIssuerAdd.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPayment.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnConfirm.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/accept.png")));
		...
		btnCancel.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/cancel.png")));
		...
		btnDelPayment.setIcon(new ImageIcon(NewSaleHotel.class.getResource("/ar/com/tourandino/resources/delete.png")));
					...
					if(orderController.getTotalCash() > 0){
						if(dailyCashRecordController.dailyRecordExist()){
							if(!dailyCashRecordController.DailyRecordIsClosed()){
								if(orderController.createHotel(cmbIssuers.getSelectedItem()) > 0){
		...
		if(passengerController.getPassenger() != null){
				if(!txtPrice.getText().isEmpty()){
					if(!txtCost.getText().isEmpty()){
						SimpleDateFormat sdf = new SimpleDateFormat("dd-MM-yyyy");
						try{
							orderController.addHotelItinerary(Float.parseFloat(txtPrice.getText()), Float.parseFloat(txtCost.getText()), txtHotel.getText(), 
									txtAddressCity.getText(), sdf.parse(txtCheckIn.getText()), sdf.parse(txtCheckOut.getText()), txtRooms.getText());
							...
							JOptionPane.showMessageDialog(this, "La fecha ingresada es inválida, por favor ingrese una nueva fecha e intente nuevamente", this.getTitle(), JOptionPane.WARNING_MESSAGE, new ImageIcon(Main.class.getResource("/ar/com/tourandino/resources/exclamation.png")));
						}
						finally{
							displayTotal(txtPriceTotal, txtCostTotal, txtSubtotal, txtTotal, txtProfitTotal);
						}
	...
	private void btnDelItineraryActionPerformed(ActionEvent evt){
		try{
			...
			int columnIndex = 0;
			orderController.removeHotelItinerary(Integer.parseInt(tablePassengers.getModel().getValueAt(rowIndex, columnIndex).toString()));
			loadTable(tablePassengers);
		}
	...
	private void loadTable(JTable table){
		table.setModel(orderController.readHotelPassengers());
	...
	private void btnCheckInActionPerformed(ActionEvent e){
		txtCheckIn.setText(new DatePicker(this).getPickedDate());
	}
	
	private void btnCheckOutActionPerformed(ActionEvent e){
		txtCheckOut.setText(new DatePicker(this).getPickedDate());
	}
}
