...
public class NewSaleBus extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public NewSaleBus(JFrame parent, boolean modal, LoginController loginController, DailyCashRecordController dailyCashRecordController) {
		super(parent, modal);
		...
		orderController.initializeBusOrder(loginController.getUser(), getTitle());
	...
	private void initializeComponents(){
		setResizable(false);
		setTitle("VENTA DE PASAJES(COLECTIVO)");
		...
		btnDate.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		...
		btnSearch1.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnCustAdd.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnSearch.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnDelItinerary.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/delete.png")));
		...
		btnAddItinerary.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPassAdd.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		lblEfectivo.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/money.png")));
		...
		lblCuenta.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/account_balances.png")));
		...
		lblCheque2.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/cheque.png")));
		...
		lblCredito.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/visa.png")));
		...
		lblDebito.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/visa_electron.png")));
		...
		btnIssuerAdd.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPayment.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnConfirm.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/accept.png")));
		...
		btnCancel.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/cancel.png")));
		...
		btnDelPayment.setIcon(new ImageIcon(NewSaleBus.class.getResource("/ar/com/tourandino/resources/delete.png")));
					...
					if(orderController.getTotalCash() > 0){
						if(dailyCashRecordController.dailyRecordExist()){
							if(!dailyCashRecordController.DailyRecordIsClosed()){
								if(orderController.createBus(cmbIssuers.getSelectedItem()) > 0){
			...
			if(!txtItinerary.getText().isEmpty()){
				if(!txtPrice.getText().isEmpty()){
					if(!txtCost.getText().isEmpty()){
						try{
							orderController.addBusItinerary(Float.parseFloat(txtPrice.getText()), Float.parseFloat(txtCost.getText()), txtItinerary.getText());
	...
	private void btnDelItineraryActionPerformed(ActionEvent evt){
		try{
			...
			int columnIndex = 0;
			orderController.removeBusItinerary(Integer.parseInt(tablePassengers.getModel().getValueAt(rowIndex, columnIndex).toString()));
			loadTable(tablePassengers);
		}
	...
	private void loadTable(JTable table){
		table.setModel(orderController.readBusPassengers());
