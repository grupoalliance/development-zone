...
public class NewSalePackage extends JDialog {
	 ...
	 * Create the dialog.
	 */
	public NewSalePackage(JFrame parent, boolean modal, LoginController loginController, DailyCashRecordController dailyCashRecordController) {
		super(parent, modal);
		...
		orderController.initializePackageOrder(loginController.getUser(), getTitle());
	...
	private void initializeComponents(){
		...
		btnDate.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/calendar.png")));
		...
		btnSearch1.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnCustAdd.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		tabbedPane.addTab("Pasajeros/Paquetes", null, panelDestiny, null);
		...
		JLabel lblPackageName = new JLabel("Paquete", SwingConstants.RIGHT);
		lblPackageName.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		lblPackageName.setBounds(12, 79, 70, 15);
		panelDestiny.add(lblPackageName);
		...
		txtPackageName.setFont(new Font("DejaVu Sans", Font.PLAIN, 12));
		txtPackageName.setBounds(100, 77, 200, 19);
		panelDestiny.add(txtPackageName);
		...
		btnSearch.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/find.png")));
		...
		btnDelItinerary.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/delete.png")));
		...
		btnAddItinerary.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPassAdd.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		lblEfectivo.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/money.png")));
		...
		lblCuenta.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/account_balances.png")));
		...
		lblCheque2.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/cheque.png")));
		...
		lblCredito.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/visa.png")));
		...
		lblDebito.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/visa_electron.png")));
		...
		btnIssuerAdd.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnPayment.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/add.png")));
		...
		btnConfirm.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/accept.png")));
		...
		btnCancel.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/cancel.png")));
		...
		btnDelPayment.setIcon(new ImageIcon(NewSalePackage.class.getResource("/ar/com/tourandino/resources/delete.png")));
					...
					if(orderController.getTotalCash() > 0){
						if(dailyCashRecordController.dailyRecordExist()){
							if(!dailyCashRecordController.DailyRecordIsClosed()){
								if(orderController.createPackage(cmbIssuers.getSelectedItem()) > 0){
		...
		if(passengerController.getPassenger() != null){
				if(!txtPrice.getText().isEmpty()){
					if(!txtCost.getText().isEmpty()){
						try{
							orderController.addPackageItinerary(txtItinerary.getText(), txtPackageName.getText(), txtNote.getText(),
	...
	private void btnDelItineraryActionPerformed(ActionEvent evt){
		try{
			...
			int columnIndex = 0;
			orderController.removePackageItinerary(Integer.parseInt(tablePassengers.getModel().getValueAt(rowIndex, columnIndex).toString()));
			loadTable(tablePassengers);
		}
	...
	private void loadTable(JTable table){
		table.setModel(orderController.readPackagePassengers());
